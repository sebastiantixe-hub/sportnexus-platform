    ...
    const events = [
        {
            ...
            price: 100.00,
            capacity: 16,
            eventType: client_1.EventType.TOURNAMENT,
        ...
        },
        {
            ...
            price: 25.00,
            capacity: 100,
            eventType: client_1.EventType.MASTERCLASS,
            organizerId: owner.id,
            isActive: true
        },
        {
            ...
            price: 40.00,
            capacity: 20,
            eventType: client_1.EventType.WORKSHOP,
            organizerId: owner.id,
            isActive: true
        },
        {
            ...
            price: 50.00,
            capacity: 150,
            eventType: client_1.EventType.CROSSFIT,
            organizerId: owner.id,
            isActive: true
        },
        {
            ...
            price: 70.00,
            capacity: 80,
            eventType: client_1.EventType.WEIGHTLIFTING,
            organizerId: owner.id,
            isActive: true
        }
    ];
...
//# sourceMappingURL=nuke-seed-events.js.map